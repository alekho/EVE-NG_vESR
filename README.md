# Добавляем Eltex vESR в EVE-NG {#1}

1. [Добавляем Eltex vESR в EVE-NG](#1)
2. [Требовани](#2)
3. [Подготавливаем шаблон](#3)
4. [Экспорт конфигурации](#4)
5. [Подготовка образа](#5)
   1. [Подготавливаем образ в Proxmox (предпочтительный вариант)](#5_1)
...
### Подготавливаем образ в Proxmox (предпочтительный вариант) {#5_1}
...
#### Настройка Virtual Serial {#5_1_2}
...
### Подготавливаем образ в EVE {#5_2}
...
#### Настройка Virtual Serial {#5_2_2}
...
## Использование нескольких экземпляров в одной лабе (Если подготавливали образ в самой EVE) {#6}
