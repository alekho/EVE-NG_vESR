...
- [Добавляем Eltex vESR в EVE-NG](#----------eltex-vesr---eve-ng)
  * [Требовани](#---------)
  * [Подготавливаем шаблон](#---------------------)
  * [Экспорт конфигурации](#--------------------)
  * [Подготовка образа](#-----------------)
    + [Подготавливаем образ в Proxmox (предпочтительный вариант)](#-----------------------proxmox---------------------------)
      - [Установка vESR](#----------vesr)
      - [Настройка Virtual Serial](#----------virtual-serial)
      - [Создание образа qcow2](#----------------qcow2)
    + [Подготавливаем образ в EVE](#-----------------------eve)
      - [Установка vESR](#----------vesr-1)
      - [Настройка Virtual Serial](#----------virtual-serial-1)
      - [Фиксация изменений](#------------------)
  * [Использование нескольких экземпляров в одной лабе (Если подготавливали образ в самой EVE)](#-------------------------------------------------------------------------------------eve-)
